...
public class FileManager {
    ...
    public static final String FILE_PATH = "src/main/resources/Report1.csv";
    ...
    public List<Log> readFile() {
        ...
        // Create header and remove from read list
        if (!readedLines.isEmpty()) {
            headers = readedLines.get(0);
            readedLines.remove(0);
        }

        return toLogObject(readedLines);
    }
